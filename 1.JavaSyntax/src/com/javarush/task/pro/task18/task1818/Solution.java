...
public class Solution {
    ...
    public static void main(String[] args) {
        var productStream = Stream.of(
                new Product("Milk", LocalDate.of(2027, Month.MARCH, 12)),
                new Product("Cheese", LocalDate.of(2025, Month.MARCH, 31)),
                new Product("Buckwheat", LocalDate.of(2029, Month.MARCH, 1)),
                new Product("Rice", LocalDate.of(2024, Month.MAY, 11)),
                new Product("Wine", LocalDate.of(2024, Month.JANUARY, 10)),
